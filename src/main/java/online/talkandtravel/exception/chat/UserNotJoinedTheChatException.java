 ...
 * member of. It extends {@link HttpException} to integrate with the application's exception
 * handling framework, providing a specific message and an HTTP status code to communicate the issue
 * to the client.
 *
 ...
 */
public class UserNotJoinedTheChatException extends WebSocketException {
